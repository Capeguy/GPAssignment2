...
{
	////To keep note of spawned rifts and see if they are dead or not, PrisonEscape uses the spawnlinks
	//in game, instead of directly accessing the memory, which may cause a crash if the entity is 
	//already dead and deleted. To ensure that spawnlinks added by PrisonEscape does not collide with spawnlinks
	//added by other stuff, (i.e. the legitimate, planned uses like Spawners), a phrase is added in front of
	//the spawn links used by PrisonEscape.
...
//=============================================================================
class PrisonEscape : public Game
{
private:
	// game items
	// Player* player;
	...
	//Tracks the total number of rifts in game. This PrisonEscape class will handle spawning.
